---
title: "04: Metabolic scaling"
author: "Fallert, S. and Cabral, J.S."
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{04: Metabolic scaling}
...
To include this effect, `metaRange` offers the option to use metabolic scaling based on the "metabolic theory of ecology" described by [Brown et al. (2004)](https://doi:10.1890/03-9000) [Ref: 1] in the following form:
...
After this point, processes could be added that use the scaled parameters.
