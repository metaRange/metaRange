...
To calculate the dispersal of in the whole landscape, this kernel is iteratively centered on each cell of the abundence matrix (i.e. the central cell in the kernel is overlapping with the cell for which we want to calculate the dispersal), and then the abundance of this cell is multiplied with the values in the kernel.
Since the kernel is a probability distribution, the result is the number of individuals that move from to central cell outwards (and also the number of individuals that stay in the source cell).
...
Conceptionally, this process is similar to applying a blur filter to an image in image processing (i.e. "blurring")  or to the mathematical operation of "convolution".
