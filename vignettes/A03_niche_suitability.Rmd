...
In order to make the simulation more interresting, we can give both species different environmental preferences for the two envionmental variables in the simulation environment (temperature & precipitation).
...
It is the responsibility of the species processes to access the correct traits and use them in a sensible way, which is why meaningfull trait names are important.
```{r add_trait_3}
sim$add_traits(
    species = "species_1",
