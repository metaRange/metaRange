...
The influence of envionmental conditions on species distribution is a central topic in ecology.
In this tutorial we will show how to implement a simple niche suitability model in metaRange.
For this, we will first create a landscape with two environmental variables (temperature and precipitation) and then add two species to it, that have different envionmental preferences.
...
Therfore, we can give both species different environmental preferences for the two envionmental variables in the simulation environment (temperature & precipitation).
