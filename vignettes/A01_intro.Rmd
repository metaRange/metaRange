...
# Adding processes
After the species and its traits are added, the processes that describe the how the species interacts with its environment can be added, using the `add_processes()` method.
