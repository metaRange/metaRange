...
## Reproduction
As an example, we are going to use different reproduction models for the two species.
...
If we would combine this with a dispersal process, this could lead to areas that are colinized by species 2, but are permanent "sinks" for the species, since they would depend on immigration from other areas and are not self-sustaing.
